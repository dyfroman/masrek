...
CHECKS: dict[str, Check] = {
    ...
    "A02": Check(
        ...
        sast_reason="semgrep detects misconfigurations in code (debug flags, insecure defaults). Runtime/server config needs DAST.",
        sast_reason_he="semgrep מזהה תצורה שגויה בקוד (דגלי דיבאג, ברירות מחדל לא מאובטחות). תצורת שרת/ריצה דורשת DAST.",
    ),
    "A03": Check(
        id="A03",
    ...
    "A07": Check(
        ...
        sast_reason="semgrep detects hardcoded credentials and secrets in source code. Auth logic flaws need DAST + manual review.",
        sast_reason_he="semgrep מזהה סיסמאות ומפתחות מוטמעים בקוד מקור. פגמי לוגיקת אימות דורשים DAST + סקירה ידנית.",
    ),
    "A08": Check(
        id="A08",
